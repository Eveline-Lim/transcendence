...
class AuthResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('requires2FA')) {
                obj['requires2FA'] = ApiClient.convertToType(data['requires2FA'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 * @default 'Bearer'
 */
AuthResponse.prototype['tokenType'] = 'Bearer';
 ...
 * @member {Boolean} requires2FA
 */
AuthResponse.prototype['requires2FA'] = undefined;
